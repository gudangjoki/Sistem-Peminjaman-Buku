            ...
            <div class="card-body pt-0">
                <div class="row">
                    <div class="col-7">
                        ...
                        <p class="text-muted text-sm"><b>{{$book->description}}</p>
                    ...
                    <div class="col-5 text-center">
                        <img src="{{ asset(''.$book->cover) }}" alt="user-avatar" class=" img-fluid">
                    </div>
                </div>
            </div>
            <div class="card-footer">
                <div class="text-right">
                    <a href="buku/edit-buku/{{ $book->book_code }}" class="btn btn-warning btn-sm" href="#">
