            ...
            <div class="card-body register-card-body">
                ...
                <form action="/register_acc" method="post">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" name="username" class="form-control" placeholder="Username" value="{{ old('username') }}" autocomplete="off">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" name="phone" class="form-control" placeholder="Phone (e.g. 82137549548)" value="{{ old('phone') }}" autocomplete="off">
                        <div class="input-group-append">
                            <div class="input-group-text">
